...
import 'package:foodease/core/widgets/common/custom_image_widget.dart';
import 'package:foodease/core/widgets/common/custom_textfield_widget.dart';
import 'package:foodease/core/widgets/common/no_internet_screen_widget.dart';
import 'package:foodease/core/widgets/common/paginated_list_view_widget.dart';
...
import 'package:foodease/features/chat/widgets/chat_shimmer_widget.dart';
import 'package:foodease/features/chat/widgets/message_bubble_widget.dart';
                      ...
                      children: [
                        Expanded(
                            child: CustomTextFieldWidget(
                                ...
                                showLabelText: false,
                                prefixIcon: AppImage.emoji,
                                suffixIcon: AppImage.attachment,
                                onTap: () {
                                  setState(() {
                                    emojiPicker = false;
                                  });
                                                ...
                                                child: Padding(
                                                    padding: const EdgeInsets.fromLTRB(
                                                        ...
                                                        Dimensions
                                                            .paddingSizeExtraExtraSmall,
                                                        8),
                                                    child: Image.asset(AppImage.send, color: Provider.of<ThemeController>(context).darkTheme ? Colors.white : null)))),
                                      ),
                              ),
                      ],
                    ),
                    ...
                    child: EmojiPicker(
                      ...
                      config: Config(
                        ...
                        noRecents: const Text('No Recents',
                            ...
                            textAlign:
                                TextAlign.center), // Needs to be const Widget
                        loadingIndicator:
