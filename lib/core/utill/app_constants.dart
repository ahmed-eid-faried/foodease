import 'package:foodease/core/localization/models/language_model.dart';
...
class AppConstants {
  ...
  static const String baseUrl = 'https://6valley-lifestyle.6amtech.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(
        imageUrl: AppImage.en,
        languageName: 'English',
        countryCode: 'US',
        languageCode: 'en'),
    LanguageModel(
        imageUrl: AppImage.ar,
        languageName: 'Arabic',
        countryCode: 'SA',
        languageCode: 'ar'),
    LanguageModel(
        imageUrl: AppImage.hi,
        languageName: 'Hindi',
        countryCode: 'IN',
        languageCode: 'hi'),
    LanguageModel(
        imageUrl: AppImage.bn,
        languageName: 'Bangla',
        countryCode: 'BD',
        languageCode: 'bn'),
    LanguageModel(
        imageUrl: AppImage.es,
